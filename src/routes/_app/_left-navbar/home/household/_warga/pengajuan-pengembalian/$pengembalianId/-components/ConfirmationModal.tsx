  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#424242]/50">
      <div className="relative mx-4 w-full max-w-[564px] rounded-[15px] bg-white p-6  shadow-lg">
        ...
        {/* Title */}
        <h2 className="mb-4 py-5 text-center text-sm font-[400] text-black lg:py-0 lg:pt-3 lg:text-start lg:text-[20px]">
          Apakah anda yakin ingin mengajukan pengembalian ini?
        </h2>
